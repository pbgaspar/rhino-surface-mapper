...
class OverlayWindow(QWidget):
    ...
    def set_navigation(self, heading_text, distance_text, heading_color, distance_color):
        """Recebe textos e cores calculados pelo núcleo, sem depender de Tkinter."""
    ...
    def paintEvent(self, event):
        """Desenha o fundo quase transparente, a moldura e as duas linhas de texto.
